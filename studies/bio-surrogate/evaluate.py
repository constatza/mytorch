...
from networks.blocks import StandardScaler
...
parser = TOMLParser(os.path.join("studies", "bio-surrogate", "io", experiment))
...
fig = plot_parametric_predictions(
    y_pred, y, x_label="Timestep", y_label=parser["variable"], title=title
)
